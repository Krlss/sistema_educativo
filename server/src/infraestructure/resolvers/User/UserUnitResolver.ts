...
import { User, Asignature, Unit, Topic } from "../../infraestructure/entities";
import { AsignatureResolver, UnitResolver, TopicResolver } from "../Asignature";
...
export class UserUnitResolver {
  ...
  //     return false;
  //   }
  //   const unit = progress.unit.find((unit) => unit.id.toString() === unitId);
  //   if (!unit) {
  //     return false;
  //   }
